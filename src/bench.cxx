...
void bench(bm::State &state, workload_t const &workload, data_accessor_t &data_accessor)
{
    ...
    for (auto _ : state)
    {
        ...
        switch (operation)
        {
        case operation_kind_t::insert_k:
            result = worker.do_insert();
            break;
        case operation_kind_t::update_k:
            result = worker.do_update();
            break;
        case operation_kind_t::remove_k:
            result = worker.do_remove();
            break;
        case operation_kind_t::read_k:
            result = worker.do_read();
            break;
        case operation_kind_t::read_modify_write_k:
            result = worker.do_read_modify_write();
            break;
        case operation_kind_t::batch_insert_k:
            result = worker.do_batch_insert();
            break;
        ...
        case operation_kind_t::range_select_k:
            ...
            break;
        case operation_kind_t::scan_k:
            result = worker.do_scan();
            break;
        default:
            throw exception_t("Unknown operation");
            break;
        }
